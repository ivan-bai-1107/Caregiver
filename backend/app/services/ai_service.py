...
def build_rule_based_response(conversation_id: str, patients: list[Patient], message: str) -> AiAssistantResponse:
    ...
    if intent == "care_record":
        ...
        answer_text, sources, risk_note = build_qa_answer(message)
