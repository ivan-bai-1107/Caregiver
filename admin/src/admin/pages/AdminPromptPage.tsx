...
import type { AdminPromptTemplate, AdminPromptTemplateDraft } from "@admin/model";
import { adminPromptStatusLabels } from "@admin/model";
import { listAdminPrompts, updateAdminPrompt } from "@admin/services/admin.service";
